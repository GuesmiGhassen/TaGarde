...
@Component({
  selector: 'app-dm-manage-doctors-form',
  templateUrl: './dm-manage-doctors-form.component.html',
  styleUrl: './dm-manage-doctors-form.component.scss',
  standalone: true,
...
export class DMManageDoctorsFormComponent {
