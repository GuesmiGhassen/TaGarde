...
@Component({
  selector: 'app-gm-department-manager-form',
  templateUrl: './gm-department-manager-form.component.html',
  styleUrl: './gm-department-manager-form.component.scss',
  standalone: true,
...
export class GmDepartmentManagerFormComponent {
