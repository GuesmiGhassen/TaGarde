...
@Component({
  selector: 'app-department-manager-profile',
  templateUrl: './department-manager-profile.component.html',
  styleUrl: './department-manager-profile.component.scss',
  standalone: true,
  imports: [CommonModule, InputTextModule, ButtonModule, CardModule, ToastModule, ReactiveFormsModule],
  providers: [MessageService]
})
export class DepartmentManagerProfileComponent {
